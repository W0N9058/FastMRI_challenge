...
def parse():
    ...
    parser.add_argument('--aug_weight_scaling', type=float, default=0.1, help='Weight of scaling probability')
    ...
    parser.add_argument('--aug_weight_fliph', type=float, default=0.0, help='Weight of horizontal flip probability')
    parser.add_argument('--aug_weight_flipv', type=float, default=0.0, help='Weight of vertical flip probability')
    parser.add_argument('--aug_max_translation_x', type=float, default=0.1, help='Maximum translation applied along the x axis as fraction of image width')
    parser.add_argument('--aug_max_translation_y', type=float, default=0.1, help='Maximum translation applied along the y axis as fraction of image height')
    parser.add_argument('--aug_max_rotation', type=float, default=10.0, help='Maximum rotation applied in either clockwise or counter-clockwise direction in degrees.')
    parser.add_argument('--aug_max_shearing_x', type=float, default=1.0, help='Maximum shearing applied in either positive or negative direction in degrees along x axis.')
    parser.add_argument('--aug_max_shearing_y', type=float, default=1.0, help='Maximum shearing applied in either positive or negative direction in degrees along y axis.')
    parser.add_argument('--aug_max_scaling', type=float, default=0.1, help='Maximum scaling applied as fraction of image dimensions.')
